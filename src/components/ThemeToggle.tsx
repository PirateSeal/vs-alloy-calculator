...
export function ThemeToggle({ showLabel = false, className }: ThemeToggleProps) {
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
      className={cn(
        "relative inline-flex h-11 w-full items-center transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
        showLabel
